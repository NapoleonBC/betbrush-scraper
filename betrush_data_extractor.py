...
# wb = Workbook()
# ws = wb.active
# ws.append(["Sport", "Country", "URL","Event Name", "Pick", "Event Date","Combo Pick",   "Formula", "Time Stamp", "Closing Odd", "Stake","Out Come"])
for data_simple in data:
    newData =[ data_simple["sport"], data_simple["country"], data_simple["URL"], data_simple["event_name" ], data_simple["pick"], data_simple["event_date" ],data_simple["combopick" ],  data_simple["formula"], data_simple["time_stamp"], data_simple["closing_odd"], data_simple["stake"], data_simple["out_come"]]
    print (newData)
# wb.save(f"{name}.xlsx")
